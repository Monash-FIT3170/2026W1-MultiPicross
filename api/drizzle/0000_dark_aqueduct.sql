...
ALTER TABLE "player_elo" ADD CONSTRAINT "player_elo_account_id_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "public"."accounts"("id)") ON DELETE cascade ON UPDATE no action; 
--> statement-breakpoint
